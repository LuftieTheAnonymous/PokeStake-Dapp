...
![PokeStake Banner](/public/Pokestake-baner.png)
...
- 🎰 **Daily Random Draws** - Once per day, draw a random card using Chainlink VRF
- 🔐 **Fully On-Chain** - Smart contracts handle all logic
- 📦 **IPFS Storage** - Card metadata stored decentrally via Pinata
- 🌈 **Multi-Wallet Support** - Connect via RainbowKit
