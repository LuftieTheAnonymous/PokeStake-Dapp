export const vrfCoordinatorAddress =
  "0x22f44f27A25053C9921037d6CDb5EDF9C05d567D";

export const vefCoordinatorAbi = [
  {
    inputs: [
  ...
  {
    inputs: [
      { internalType: "address", name: "coordinatorAddress", type: "address" },
    ],
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: "uint8", name: "linkPremiumPercentage", type: "uint8" },
    ],
    stateMutability: "view",
    type: "function",
  },
